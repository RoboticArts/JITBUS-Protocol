...
---------------------------------------------------------------------
File: GUI Robotic Management System.py

Description:
This file creates an interface to test the JITBUS protocol between serial devices.
In the future this GUI will be responsible for managing the electronic system of
a robot. However, now it serves to test the JITBUS protocol in a simple way. There
are two ways to test this file:

            -   Using an FTDI chip in loopback mode.
            -   Using a device that implements the JITBUS protocol
