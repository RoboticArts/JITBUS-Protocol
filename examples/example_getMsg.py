...
---------------------------------------------------------------------
File: example_getMsg.py

Description: This example shows how to receive one by one the messages
available in the buffer. Remember to connect the FTDI module in loopback
...
for x in range(20):
    ...
    if myJitbus.availableMsg() > 0:
        ...
        #Get all the messages one by one
